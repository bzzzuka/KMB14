# Сетка Соболя для d-мерного гиперкуба
...
*1)* Для примера рассмотрим 5-ю точку. Тогда (5)10 = (101)2
*2)* 1 - 1-ый справа разряд , 0 - 2-й справа разряд, 1 - 3-й справа разряд
*3)* Нам нужны v1 и v3. Так как 2-й справа разряд равен 0, v2 нам не нужно
*4)* x5j = v1 XOR v3 = (0.1)2 XOR (0.111)2  = 0.375
